...
description: 'Write structured technical documentation such as user guides, how-to articles, architecture docs, onboarding, tutorials, API explanations, or knowledge-base content.'
---
