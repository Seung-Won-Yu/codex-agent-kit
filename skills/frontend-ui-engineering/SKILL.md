...
description: 'Implement a specified interface, component, layout, interaction, or state flow at production quality. Use when requirements or design are clear; not for product planning, audit-only work, or standalone visual concepts.'
---
