---
name: caveman
description: 'Persistent ultra-compressed communication mode. Use only for /caveman, "caveman mode", or an explicit persistent token-saving mode; not for ordinary requests to be concise.'
---
