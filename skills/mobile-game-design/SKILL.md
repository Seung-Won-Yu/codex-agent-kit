...
description: Shape mobile game concepts into playable design briefs. Use when ideating a mobile game, drafting or reviewing a GDD, defining core loops, FTUE, progression, retention hooks, missions, rewards, economy, or deciding what the player should do moment to moment.
---
