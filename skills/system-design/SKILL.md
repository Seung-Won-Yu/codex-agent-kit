---
name: system-design
description: 'Design or evaluate whole-system architecture, service boundaries, scaling, reliability, data flow, and major tradeoffs. Not for an API contract, module interface, or database schema alone.'
---
