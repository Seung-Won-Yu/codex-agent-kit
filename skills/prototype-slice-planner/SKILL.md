...
description: Decide the smallest playable mobile game prototype slice. Use after a concept or design review when choosing what to build first, what to fake, what hypothesis to test, success metrics, failure signals, and implementation handoff scope.
---
