...
- Codex-native image generation direction
...
| Skill | Source | Why It Is Useful |
| --- | --- | --- |
| `media-image-director` | Local adaptation inspired by Open Design media skills | Keeps image generation focused on Codex-native prompting, generation, critique, and iteration. |

## Import Policy

- Keep imported skill names prefixed with `od-`.
- Keep local media skill names prefixed with `media-`.
