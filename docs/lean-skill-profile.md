...
- Keep about 100 representative skills available locally.
...
- Keep `caveman` available for compressed routine communication while preserving normal prose for artifacts.
