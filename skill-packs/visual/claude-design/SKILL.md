---
name: claude-design
description: 'Create a high-fidelity standalone HTML visual concept, mockup, clickable prototype, storyboard, poster, or design exploration. Use when visual options are the deliverable; not for production app code or existing-UI audits.'
---
