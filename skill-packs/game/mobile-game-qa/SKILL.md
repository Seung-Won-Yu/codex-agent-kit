---
name: mobile-game-qa
description: 'Verify a mobile-game UI or playable prototype for touch usability, HUD readability, safe layout, feedback, accessibility, performance basics, analytics, and release readiness.'
---
...
Pair with `$webapp-testing`, `$playwright`, or the available in-app Browser capability for browser-based prototypes.
