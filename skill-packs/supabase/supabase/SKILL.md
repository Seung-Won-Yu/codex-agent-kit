---
name: supabase
description: 'Use for any Supabase task: Database, Auth, RLS, Edge Functions, Realtime, Storage, Vectors, Cron, Queues, client/SSR integration, CLI/MCP, migrations, or Supabase Postgres extensions.'
metadata:
  author: supabase
  version: "0.1.2"
---
